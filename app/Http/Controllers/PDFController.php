...
class PDFController extends Controller
{
        public function cargarBD(Request $request)
        {
            ...
            }else if($orden=='generarpdf4Riesgos')
            {
                $reporteRiesgos = DB::select('SELECT riesgos.id, riesgos.nom_riesgos, categoria_riesgos.nombre_categoria, riesgos.des_detalle, proceso_afectas.id_nomenclatura, probabilidads.nom_probabilidad, impactos.nom_impacto, riesgos.tot_calificacion, riesgos.num_pos_matriz, accions.nombre_accion, riesgos.ind_afecta_servicio, riesgos.num_rto, riesgos.id_unidad_medida, riesgos.tot_tolerancia, riesgos.tot_capacidad, riesgos.usr_creacion, riesgos.usr_modifica, riesgos.ind_estado, riesgos.nom_archivo, riesgos.created_at, unidad_medidas.nom_unidad_medida FROM `riesgos`, `categoria_riesgos`, `proceso_afectas`, `probabilidads`, `impactos`, `accions`, `unidad_medidas` WHERE unidad_medidas.id = riesgos.id_unidad_medida and riesgos.id_categoria = categoria_riesgos.id and riesgos.id_proceso_afecta = proceso_afectas.id and riesgos.id_probabilidad = probabilidads.id and riesgos.id_impacto = impactos.id and riesgos.id_accion = accions.id and riesgos.id_accion=1;');
            return view ('vwReportePDFRiesgo', [
                'reporteRiesgos' => $reporteRiesgos
            ]);
            }else if($orden=='generarpdf5Riesgos')
            {
                $reporteRiesgos = DB::select('SELECT riesgos.id, riesgos.nom_riesgos, categoria_riesgos.nombre_categoria, riesgos.des_detalle, proceso_afectas.id_nomenclatura, probabilidads.nom_probabilidad, impactos.nom_impacto, riesgos.tot_calificacion, riesgos.num_pos_matriz, accions.nombre_accion, riesgos.ind_afecta_servicio, riesgos.num_rto, riesgos.id_unidad_medida, riesgos.tot_tolerancia, riesgos.tot_capacidad, riesgos.usr_creacion, riesgos.usr_modifica, riesgos.ind_estado, riesgos.nom_archivo, riesgos.created_at, unidad_medidas.nom_unidad_medida FROM `riesgos`, `categoria_riesgos`, `proceso_afectas`, `probabilidads`, `impactos`, `accions`, `unidad_medidas` WHERE unidad_medidas.id = riesgos.id_unidad_medida and riesgos.id_categoria = categoria_riesgos.id and riesgos.id_proceso_afecta = proceso_afectas.id and riesgos.id_probabilidad = probabilidads.id and riesgos.id_impacto = impactos.id and riesgos.id_accion = accions.id and riesgos.id_accion=2;');
            return view ('vwReportePDFRiesgo', [
                'reporteRiesgos' => $reporteRiesgos
            ]);
            }else if($orden=='generarpdf6Riesgos')
            {
                $reporteRiesgos = DB::select('SELECT riesgos.id, riesgos.nom_riesgos, categoria_riesgos.nombre_categoria, riesgos.des_detalle, proceso_afectas.id_nomenclatura, probabilidads.nom_probabilidad, impactos.nom_impacto, riesgos.tot_calificacion, riesgos.num_pos_matriz, accions.nombre_accion, riesgos.ind_afecta_servicio, riesgos.num_rto, riesgos.id_unidad_medida, riesgos.tot_tolerancia, riesgos.tot_capacidad, riesgos.usr_creacion, riesgos.usr_modifica, riesgos.ind_estado, riesgos.nom_archivo, riesgos.created_at, unidad_medidas.nom_unidad_medida FROM `riesgos`, `categoria_riesgos`, `proceso_afectas`, `probabilidads`, `impactos`, `accions`, `unidad_medidas` WHERE unidad_medidas.id = riesgos.id_unidad_medida and riesgos.id_categoria = categoria_riesgos.id and riesgos.id_proceso_afecta = proceso_afectas.id and riesgos.id_probabilidad = probabilidads.id and riesgos.id_impacto = impactos.id and riesgos.id_accion = accions.id and riesgos.id_accion=3;');
            return view ('vwReportePDFRiesgo', [
                'reporteRiesgos' => $reporteRiesgos
            ]);
            }else if($orden=='generarpdf7Riesgos')
            {
                $reporteRiesgos = DB::select('SELECT riesgos.id, riesgos.nom_riesgos, categoria_riesgos.nombre_categoria, riesgos.des_detalle, proceso_afectas.id_nomenclatura, probabilidads.nom_probabilidad, impactos.nom_impacto, riesgos.tot_calificacion, riesgos.num_pos_matriz, accions.nombre_accion, riesgos.ind_afecta_servicio, riesgos.num_rto, riesgos.id_unidad_medida, riesgos.tot_tolerancia, riesgos.tot_capacidad, riesgos.usr_creacion, riesgos.usr_modifica, riesgos.ind_estado, riesgos.nom_archivo, riesgos.created_at, unidad_medidas.nom_unidad_medida FROM `riesgos`, `categoria_riesgos`, `proceso_afectas`, `probabilidads`, `impactos`, `accions`, `unidad_medidas` WHERE unidad_medidas.id = riesgos.id_unidad_medida and riesgos.id_categoria = categoria_riesgos.id and riesgos.id_proceso_afecta = proceso_afectas.id and riesgos.id_probabilidad = probabilidads.id and riesgos.id_impacto = impactos.id and riesgos.id_accion = accions.id and riesgos.id_accion=4;');
                return view ('vwReportePDFRiesgo', [
                    'reporteRiesgos' => $reporteRiesgos
                ]);
            }
