...
<div class="container-fluid px-4">
    ...
    <div class="row">
        ...
        <label for="txtAccion">Descripción de la Acción</label>
            <input type="text" class="form-control {{$errors->has('nombre_accion')?'is-invalid':'' }}" id="txtAccion" name="nombre_accion" placeholder="Descipción de la acción de riesgo" value="{{old('nombre_accion')}}">
