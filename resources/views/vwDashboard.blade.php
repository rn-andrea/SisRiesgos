        ...
        <div class="row">
            <div class="col-xl-2 col-md-6">
                <div class="card bg-primary text-white mb-4">
                    <div class="card-body">Mínimo (16)</div>
            ...
            <div class="col-xl-2 col-md-6">
                <div class="card bg-success text-white mb-4">
                    <div class="card-body">Bajo (10)</div>
                    <div class="card-footer d-flex align-items-center justify-content-between">
            ...
            <div class="col-xl-2 col-md-6">
                <div class="card bg-warning text-white mb-4">
                    <div class="card-body">Moderado (6)</div>
                    <div class="card-footer d-flex align-items-center justify-content-between">
                        <a class="small text-white stretched-link" href="#">Ver Detalle</a>
                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                    </div>
            ...
            <div class="col-xl-2 col-md-6">
                <div class="riesgoalto text-white mb-4">
                    <div class="card-body">Alto (5)</div>
                    <div class="card-footer d-flex align-items-center justify-content-between">
                        <a class="small text-white stretched-link" href="#">Ver Detalle</a>
                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                    </div>
            ...
            <div class="col-xl-2 col-md-6">
                <div class="card bg-danger text-white mb-4">
                    <div class="card-body">Crítico (3)</div>
                    <div class="card-footer d-flex align-items-center justify-content-between">
                        <a class="small text-white stretched-link" href="#">Ver Detalle</a>
                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                    </div>
            ...
            <div class="col-xl-6">
                <div class="card mb-4">
                    ...
                    <tbody>
                        ...
                        <td class="bg-warning text-white">10</td>
                        <td style="background-color: #f57c02;" class="text-white">15</td>
                        <td class="bg-danger text-white">20</td>
                        <td class="bg-danger text-white">25</td>
                        </tr>
                        <tr>
                        <th scope="row">Muy probable</th>
                        <td class="bg-primary text-white">4</td>
                        <td class="bg-success text-white">8</td>
                        <td class="bg-warning text-white">12</td>
                        <td style="background-color: #f57c02;" class="text-white">16</td>
                        <td class="bg-danger text-white">20</td>
                        </tr>
                        <tr>
                        <th scope="row">Ocasionalmente</th>
                        <td class="bg-primary text-white">3</td>
                        <td class="bg-success text-white">6</td>
                        <td class="bg-warning text-white">9</td>
                        <td class="bg-warning text-white">12</td>
                        <td style="background-color: #f57c02;" class="text-white">15</td>
                        <tr>
                        <th scope="row">Rara Vez</th>
                        <td class="bg-primary text-white">2</td>
                        <td class="bg-primary text-white">4</td>
                        <td class="bg-success text-white">6</td>
                        <td class="bg-success text-white">8</td>
                        <td class="bg-warning text-white">10</td>
